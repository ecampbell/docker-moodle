...
RUN apt-get -y install apache2 php5 php5-gd libapache2-mod-php5 ssmtp php5-xsl wget supervisor php5-pgsql vim curl libcurl3 libcurl3-dev php5-curl php5-xmlrpc php5-intl php5-mysql
